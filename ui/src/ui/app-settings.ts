...
export async function refreshActiveTab(host: SettingsHost) {
  ...
  if (host.tab === "instances") await loadPresence(host as unknown as BotApp);
  if (host.tab === "sessions") await loadSessions(host as unknown as BotApp);
  if (host.tab === "cron") await loadCron(host);
  if (host.tab === "skills") await loadSkills(host as unknown as BotApp);
  if (host.tab === "nodes") {
