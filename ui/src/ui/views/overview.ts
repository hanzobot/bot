  ...
  const authHint = (() => {
      ...
      return html`
        <div class="muted" style="margin-top: 8px;">
          ...
          <div style="margin-top: 6px;">
            <a
              class="session-link"
              href="https://docs.bot.hanzo.ai/web/dashboard"
              target="_blank"
              rel="noreferrer"
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        ...
        <span class="mono">bot dashboard --no-open</span>, or update the token,
        then click Connect.
        <div style="margin-top: 6px;">
          <a
            class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        ...
        <div style="margin-top: 6px;">
          <a
            class="session-link"
            href="https://docs.bot.hanzo.ai/gateway/tailscale"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            class="session-link"
            href="https://docs.bot.hanzo.ai/web/control-ui#insecure-http"
            target="_blank"
            rel="noreferrer"
