...
TRASH
  ...
  send_skills_flow() {
    ...
    workspace_dir="$HOME/.hanzo/bot/workspace"
    config_path="$HOME/.hanzo/bot/bot.json"
    sessions_dir="$HOME/.hanzo/bot/agents/main/sessions"
...
NODE
  ...
  run_case_reset() {
    ...
    # Seed a remote config to exercise reset path.
	    cat > "$HOME/.hanzo/bot/bot.json" <<'"'"'JSON'"'"'
{
  "meta": {},
