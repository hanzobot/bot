...
echo "   scp $SCRIPT_DIR/termux-quick-auth.sh phone:~/.shortcuts/HanzoAuth"
echo "   scp $SCRIPT_DIR/termux-auth-widget.sh phone:~/.shortcuts/HanzoAuth-Full"
echo ""
echo "4. Make them executable on phone:"
echo "   ssh phone 'chmod +x ~/.shortcuts/Hanzo*'"
echo ""
echo "5. Add Termux:Widget to your home screen"
echo "6. Tap the widget to see your auth scripts"
echo ""
echo "The quick widget (HanzoAuth) shows status and opens auth URL if needed."
echo "The full widget (HanzoAuth-Full) provides guided re-auth flow."
echo ""
