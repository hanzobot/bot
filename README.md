...
<p align="center">
  <img src="https://raw.githubusercontent.com/bot/bot/main/docs/whatsapp-bot.jpg" alt="Bot" width="400">
</p>
...
<p align="center">
  ...
  <a href="https://deepwiki.com/bot/bot"><img src="https://img.shields.io/badge/DeepWiki-bot-111111?style=for-the-badge" alt="DeepWiki"></a>
...
**Bot** is a *personal AI assistant* you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://bot.com) · [Docs](https://docs.bot.hanzo.ai) · [Getting Started](https://docs.bot.hanzo.ai/start/getting-started) · [Updating](https://docs.bot.hanzo.ai/install/updating) · [Showcase](https://docs.bot.hanzo.ai/start/showcase) · [FAQ](https://docs.bot.hanzo.ai/start/faq) · [Wizard](https://docs.bot.hanzo.ai/start/wizard) · [Nix](https://github.com/bot/nix-bot) · [Docker](https://docs.bot.hanzo.ai/install/docker) · [Discord](https://discord.gg/bot)

Preferred setup: run the onboarding wizard (`bot onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.bot.hanzo.ai/start/getting-started)

**Subscriptions (OAuth):**
- **[Anthropic](https://www.anthropic.com/)** (Claude Pro/Max)
- **[OpenAI](https://openai.com/)** (ChatGPT/Codex)

Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.bot.hanzo.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.bot.hanzo.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.bot.hanzo.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.bot.hanzo.ai/start/getting-started)
...
Upgrading? [Updating guide](https://docs.bot.hanzo.ai/install/updating) (and run `bot doctor`).
...
Details: [Development channels](https://docs.bot.hanzo.ai/install/development-channels).
...
Full security guide: [Security](https://docs.bot.hanzo.ai/gateway/security)
...
- **[Local-first Gateway](https://docs.bot.hanzo.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.bot.hanzo.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.bot.hanzo.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.bot.hanzo.ai/nodes/voicewake) + [Talk Mode](https://docs.bot.hanzo.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.bot.hanzo.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.bot.hanzo.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.bot.hanzo.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.bot.hanzo.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.bot.hanzo.ai/nodes).
- **[Onboarding](https://docs.bot.hanzo.ai/start/wizard) + [skills](https://docs.bot.hanzo.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.
...
### Core platform
- [Gateway WS control plane](https://docs.bot.hanzo.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.bot.hanzo.ai/web), and [Canvas host](https://docs.bot.hanzo.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.bot.hanzo.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.bot.hanzo.ai/start/wizard), and [doctor](https://docs.bot.hanzo.ai/gateway/doctor).
- [Pi agent runtime](https://docs.bot.hanzo.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.bot.hanzo.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.bot.hanzo.ai/concepts/groups).
- [Media pipeline](https://docs.bot.hanzo.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.bot.hanzo.ai/nodes/audio).

### Channels
- [Channels](https://docs.bot.hanzo.ai/channels): [WhatsApp](https://docs.bot.hanzo.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.bot.hanzo.ai/channels/telegram) (grammY), [Slack](https://docs.bot.hanzo.ai/channels/slack) (Bolt), [Discord](https://docs.bot.hanzo.ai/channels/discord) (discord.js), [Google Chat](https://docs.bot.hanzo.ai/channels/googlechat) (Chat API), [Signal](https://docs.bot.hanzo.ai/channels/signal) (signal-cli), [iMessage](https://docs.bot.hanzo.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.bot.hanzo.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.bot.hanzo.ai/channels/msteams) (extension), [Matrix](https://docs.bot.hanzo.ai/channels/matrix) (extension), [Zalo](https://docs.bot.hanzo.ai/channels/zalo) (extension), [Zalo Personal](https://docs.bot.hanzo.ai/channels/zalouser) (extension), [WebChat](https://docs.bot.hanzo.ai/web/webchat).
- [Group routing](https://docs.bot.hanzo.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.bot.hanzo.ai/channels).

### Apps + nodes
- [macOS app](https://docs.bot.hanzo.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.bot.hanzo.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.bot.hanzo.ai/nodes/talk) overlay, [WebChat](https://docs.bot.hanzo.ai/web/webchat), debug tools, [remote gateway](https://docs.bot.hanzo.ai/gateway/remote) control.
- [iOS node](https://docs.bot.hanzo.ai/platforms/ios): [Canvas](https://docs.bot.hanzo.ai/platforms/mac/canvas), [Voice Wake](https://docs.bot.hanzo.ai/nodes/voicewake), [Talk Mode](https://docs.bot.hanzo.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.bot.hanzo.ai/platforms/android): [Canvas](https://docs.bot.hanzo.ai/platforms/mac/canvas), [Talk Mode](https://docs.bot.hanzo.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.bot.hanzo.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation
- [Browser control](https://docs.bot.hanzo.ai/tools/browser): dedicated bot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.bot.hanzo.ai/platforms/mac/canvas): [A2UI](https://docs.bot.hanzo.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.bot.hanzo.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.bot.hanzo.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.bot.hanzo.ai/automation/cron-jobs); [webhooks](https://docs.bot.hanzo.ai/automation/webhook); [Gmail Pub/Sub](https://docs.bot.hanzo.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.bot.hanzo.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety
- [Channel routing](https://docs.bot.hanzo.ai/concepts/channel-routing), [retry policy](https://docs.bot.hanzo.ai/concepts/retry), and [streaming/chunking](https://docs.bot.hanzo.ai/concepts/streaming).
- [Presence](https://docs.bot.hanzo.ai/concepts/presence), [typing indicators](https://docs.bot.hanzo.ai/concepts/typing-indicators), and [usage tracking](https://docs.bot.hanzo.ai/concepts/usage-tracking).
- [Models](https://docs.bot.hanzo.ai/concepts/models), [model failover](https://docs.bot.hanzo.ai/concepts/model-failover), and [session pruning](https://docs.bot.hanzo.ai/concepts/session-pruning).
- [Security](https://docs.bot.hanzo.ai/gateway/security) and [troubleshooting](https://docs.bot.hanzo.ai/channels/troubleshooting).

### Ops + packaging
- [Control UI](https://docs.bot.hanzo.ai/web) + [WebChat](https://docs.bot.hanzo.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.bot.hanzo.ai/gateway/tailscale) or [SSH tunnels](https://docs.bot.hanzo.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.bot.hanzo.ai/install/nix) for declarative config; [Docker](https://docs.bot.hanzo.ai/install/docker)-based installs.
- [Doctor](https://docs.bot.hanzo.ai/gateway/doctor) migrations, [logging](https://docs.bot.hanzo.ai/logging).
...
- **[Gateway WebSocket network](https://docs.bot.hanzo.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.bot.hanzo.ai/gateway)).
- **[Tailscale exposure](https://docs.bot.hanzo.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.bot.hanzo.ai/gateway/remote)).
- **[Browser control](https://docs.bot.hanzo.ai/tools/browser)** — bot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.bot.hanzo.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.bot.hanzo.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.bot.hanzo.ai/nodes/voicewake) + [Talk Mode](https://docs.bot.hanzo.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.bot.hanzo.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.
...
Details: [Tailscale guide](https://docs.bot.hanzo.ai/gateway/tailscale) · [Web surfaces](https://docs.bot.hanzo.ai/web)
...
Details: [Remote access](https://docs.bot.hanzo.ai/gateway/remote) · [Nodes](https://docs.bot.hanzo.ai/nodes) · [Security](https://docs.bot.hanzo.ai/gateway/security)
...
Details: [Nodes](https://docs.bot.hanzo.ai/nodes) · [macOS app](https://docs.bot.hanzo.ai/platforms/macos) · [Gateway protocol](https://docs.bot.hanzo.ai/concepts/architecture)
...
Details: [Session tools](https://docs.bot.hanzo.ai/concepts/session-tool)

## Skills registry (Skills)

Skills is a minimal skill registry. With Skills enabled, the agent can search for skills automatically and pull in new ones as needed.
...
Runbook: [iOS connect](https://docs.bot.hanzo.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.bot.hanzo.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/bot` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/bot/skills/<skill>/SKILL.md`.
...
[Full configuration reference (all keys + examples).](https://docs.bot.hanzo.ai/gateway/configuration)
...
Details: [Security guide](https://docs.bot.hanzo.ai/gateway/security) · [Docker + sandboxing](https://docs.bot.hanzo.ai/install/docker) · [Sandbox config](https://docs.bot.hanzo.ai/gateway/configuration)

### [WhatsApp](https://docs.bot.hanzo.ai/channels/whatsapp)

- Link the device: `pnpm bot channels login` (stores creds in `~/.bot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.bot.hanzo.ai/channels/telegram)
...
### [Slack](https://docs.bot.hanzo.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.bot.hanzo.ai/channels/discord)
...
### [Signal](https://docs.bot.hanzo.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.bot.hanzo.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.bot.hanzo.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.bot.hanzo.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.bot.hanzo.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.bot.hanzo.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.bot.hanzo.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.bot.hanzo.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.bot.hanzo.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.bot.hanzo.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.bot.hanzo.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.bot.hanzo.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.bot.hanzo.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.bot.hanzo.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.bot.hanzo.ai/platforms/windows), [Linux](https://docs.bot.hanzo.ai/platforms/linux), [macOS](https://docs.bot.hanzo.ai/platforms/macos), [iOS](https://docs.bot.hanzo.ai/platforms/ios), [Android](https://docs.bot.hanzo.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.bot.hanzo.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.bot.hanzo.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.bot.hanzo.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.bot.hanzo.ai/gateway/bonjour)
- [Gateway pairing](https://docs.bot.hanzo.ai/gateway/pairing)
- [Remote gateway README](https://docs.bot.hanzo.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.bot.hanzo.ai/web/control-ui)
- [Dashboard](https://docs.bot.hanzo.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.bot.hanzo.ai/gateway/health)
- [Gateway lock](https://docs.bot.hanzo.ai/gateway/gateway-lock)
- [Background process](https://docs.bot.hanzo.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.bot.hanzo.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.bot.hanzo.ai/logging)

## Deep dives

- [Agent loop](https://docs.bot.hanzo.ai/concepts/agent-loop)
- [Presence](https://docs.bot.hanzo.ai/concepts/presence)
- [TypeBox schemas](https://docs.bot.hanzo.ai/concepts/typebox)
- [RPC adapters](https://docs.bot.hanzo.ai/reference/rpc)
- [Queue](https://docs.bot.hanzo.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.bot.hanzo.ai/tools/skills-config)
- [Default AGENTS](https://docs.bot.hanzo.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.bot.hanzo.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.bot.hanzo.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.bot.hanzo.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.bot.hanzo.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.bot.hanzo.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.bot.hanzo.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.bot.hanzo.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.bot.hanzo.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.bot.hanzo.ai/platforms/mac/voicewake)
- [iOS node](https://docs.bot.hanzo.ai/platforms/ios)
- [Android node](https://docs.bot.hanzo.ai/platforms/android)
- [Windows (WSL2)](https://docs.bot.hanzo.ai/platforms/windows)
- [Linux app](https://docs.bot.hanzo.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.bot.hanzo.ai/gmail-pubsub](https://docs.bot.hanzo.ai/automation/gmail-pubsub)

## Bot

Bot was built for **Bot**, a space lobster AI assistant. 🦞
...
<p align="left">
  ...
  <a href="https://github.com/Syhids"><img src="https://avatars.githubusercontent.com/u/671202?v=4&s=48" width="48" height="48" alt="Syhids" title="Syhids"/></a> <a href="https://github.com/search?q=Aaron%20Konyer"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Aaron Konyer" title="Aaron Konyer"/></a> <a href="https://github.com/aaronveklabs"><img src="https://avatars.githubusercontent.com/u/225997828?v=4&s=48" width="48" height="48" alt="aaronveklabs" title="aaronveklabs"/></a> <a href="https://github.com/andreabadesso"><img src="https://avatars.githubusercontent.com/u/3586068?v=4&s=48" width="48" height="48" alt="andreabadesso" title="andreabadesso"/></a> <a href="https://github.com/search?q=Andrii"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Andrii" title="Andrii"/></a> <a href="https://github.com/cash-echo-bot"><img src="https://avatars.githubusercontent.com/u/252747386?v=4&s=48" width="48" height="48" alt="cash-echo-bot" title="cash-echo-bot"/></a> <a href="https://github.com/search?q=Bot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Bot" title="Bot"/></a> <a href="https://github.com/search?q=BotFx"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="BotFx" title="BotFx"/></a> <a href="https://github.com/dguido"><img src="https://avatars.githubusercontent.com/u/294844?v=4&s=48" width="48" height="48" alt="dguido" title="dguido"/></a> <a href="https://github.com/EnzeD"><img src="https://avatars.githubusercontent.com/u/9866900?v=4&s=48" width="48" height="48" alt="EnzeD" title="EnzeD"/></a>
