...
import { resolveAgentModelFallbacksOverride as resolveRunModelFallbacksOverride } from "../../agents/agent-scope.js";
    ...
    try {
      ...
      try {
        const fallbackResult = await runWithModelFallback({
          ...
          fallbacksOverride:
            queued.run.config && queued.run.agentId
              ? resolveRunModelFallbacksOverride(queued.run.config, queued.run.agentId)
              : undefined,
          run: (provider, model) => {
