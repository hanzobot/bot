...
export const DEFAULT_SANDBOX_IMAGE = "hanzo-bot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "hanzo-bot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "hanzo-bot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "hanzo-bot-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "hanzo-bot-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "hanzo-bot-sandbox-browser";
