...
import { DEFAULT_BOT_BROWSER_COLOR } from "../../browser/constants.js";
...
function buildSandboxBrowserResolvedConfig(params: {
  ...
  return {
    ...
    defaultProfile: "bot",
    profiles: {
      bot: { cdpPort: params.cdpPort, color: DEFAULT_BOT_BROWSER_COLOR },
    },
  };
}
...
export async function ensureSandboxBrowser(params: {
  ...
  const existingProfile = existing ? resolveProfile(existing.bridge.state.resolved, "bot") : null;
  const shouldReuse =
