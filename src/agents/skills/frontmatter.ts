...
export function resolveBotMetadata(
  ...
  try {
    ...
    return {
      ...
      skillKey: typeof botObj.skillKey === "string" ? botObj.skillKey : undefined,
      primaryEnv: typeof botObj.primaryEnv === "string" ? botObj.primaryEnv : undefined,
...
export function resolveSkillKey(skill: Skill, entry?: SkillEntry): string {
  return entry?.bot?.skillKey ?? skill.name;
}
