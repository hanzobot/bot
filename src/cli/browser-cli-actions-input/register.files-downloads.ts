...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within hanzo-bot temp downloads dir (default: /tmp/bot/downloads/...; fallback: os.tmpdir()/bot/downloads/...)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within hanzo-bot temp downloads dir (e.g. report.pdf or /tmp/bot/downloads/report.pdf)",
    )
    .option("--target-id <id>", "CDP target id (or unique prefix)")
    .option(
      "--timeout-ms <ms>",
