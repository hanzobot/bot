...
describe("docker-setup.sh", () => {
  it("handles unset optional env vars under strict mode", async () => {
    ...
    const env = {
      ...
      BOT_CONFIG_DIR: join(rootDir, "config"),
      BOT_WORKSPACE_DIR: join(rootDir, "bot"),
    };
    delete env.BOT_DOCKER_APT_PACKAGES;
    delete env.BOT_EXTRA_MOUNTS;
    delete env.BOT_HOME_VOLUME;
