...
async function requireRiskAcknowledgement(params: {
  ...
  await params.prompter.note(
    [
      "Please read: https://docs.bot.hanzo.ai/security",
      "",
      "Bot agents can run commands, read/write files, and act through any tools you enable. They can only send messages on channels you configure (for example, an account you log in on this machine, or a bot account like Slack/Discord).",
      "",
      ...
      "Learn more: https://docs.bot.hanzo.ai/sandboxing",
    ].join("\n"),
    "Security",
  );
    ...
    if (snapshot.issues.length > 0) {
      await prompter.note(
        [
          ...
          "",
          "Docs: https://docs.bot.hanzo.ai/gateway/configuration",
        ].join("\n"),
        "Config issues",
      );
    }
