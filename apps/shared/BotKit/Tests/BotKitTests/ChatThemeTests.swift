...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = BotChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = BotChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
