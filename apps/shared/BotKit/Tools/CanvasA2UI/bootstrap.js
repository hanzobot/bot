...
import "@a2ui/lit/ui";
import { themeContext } from "@bot/a2ui-theme-context";
...
class BotA2UIHost extends LitElement {
  ...
  connectedCallback() {
    ...
    globalThis.addEventListener("bot:a2ui-action-status", this.#statusListener);
    this.#syncSurfaces();
  }
  ...
  disconnectedCallback() {
    ...
    if (this.#statusListener) {
      globalThis.removeEventListener("bot:a2ui-action-status", this.#statusListener);
