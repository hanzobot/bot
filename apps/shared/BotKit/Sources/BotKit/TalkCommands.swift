...
public enum BotTalkCommand: String, Codable, Sendable {
...
public struct BotTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct BotTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
