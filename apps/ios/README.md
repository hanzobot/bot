...
This iPhone app is super-alpha and internal-use only. It connects to an Bot Gateway as a `role: node`.
...
- `apps/ios/Sources/Bot.entitlements` sets `aps-environment` to `development`.
