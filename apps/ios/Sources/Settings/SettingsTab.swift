                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Bot agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Bot. "
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Bot is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Bot", value: DeviceInfoHelper.botVersionString())
                    }
                }
            }
