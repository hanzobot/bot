...
final class BotAppDelegate: NSObject, UIApplicationDelegate, @preconcurrency UNUserNotificationCenterDelegate {
    private let logger = Logger(subsystem: "ai.hanzo.ios", category: "Push")
    private let backgroundWakeLogger = Logger(subsystem: "ai.hanzo.ios", category: "BackgroundWake")
    private static let wakeRefreshTaskIdentifier = "ai.hanzo.ios.bgrefresh"
