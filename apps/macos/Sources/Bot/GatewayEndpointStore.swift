...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "com.bot", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "com.bot", category: "gateway-endpoint")
