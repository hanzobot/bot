...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.bot", category: "PeekabooBridge")
    ...
    private func startIfNeeded() async {
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.botSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.botSocketPath, privacy: .public)")
    }
...
private final class BotPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.bot.peekaboo")
