...
import ai.hanzo.bot.android.ui.mobileSurface
import ai.hanzo.bot.android.ui.mobileText
import ai.hanzo.bot.android.ui.mobileTextSecondary
import ai.hanzo.bot.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.hanzo.bot.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.hanzo.bot.android.ui.mobileFontFamily,
