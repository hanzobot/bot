...
- **ClawHub** — [bot/clawhub](https://github.com/hanzoai/clawhub)
- **Trust and threat model** — [bot/trust](https://github.com/hanzoai/trust)
...
- Anyone who can modify `~/.hanzo/bot` state/config (including `bot.json`) is effectively a trusted operator.
