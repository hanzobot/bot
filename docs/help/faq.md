...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [I can't access docs.bot.hanzo.ai (SSL error). What now?](#i-cant-access-docsbot-ssl-error-what-now)
...
```bash
curl -fsSL https://bot.hanzo.ai/install.sh | bash -s -- --install-method git
```
...
Some Comcast/Xfinity connections incorrectly block `docs.bot.hanzo.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.bot.hanzo.ai`, then retry. More
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://bot.hanzo.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://bot.hanzo.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://bot.hanzo.ai/install.ps1
...
```bash
curl -fsSL https://bot.hanzo.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://bot.hanzo.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://bot.hanzo.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Showcase: https://bot.hanzo.ai/showcase
...
Still stuck? Ask in [Discord](https://discord.com/invite/bot) or open a [GitHub discussion](https://github.com/bot/bot/discussions).
