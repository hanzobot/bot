...
| Variable               | Purpose                                                                                                                                                                          |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BOT_HOME`        | Override the home directory used for all internal path resolution (`~/.hanzo/bot/`, agent dirs, sessions, credentials). Useful when running Bot as a dedicated service user. |
