...
### `docs.bot.hanzo.ai` shows an SSL error (Comcast/Xfinity)

Some Comcast/Xfinity connections block `docs.bot.hanzo.ai` via Xfinity Advanced Security.
Disable Advanced Security or add `docs.bot.hanzo.ai` to the allowlist, then retry.
