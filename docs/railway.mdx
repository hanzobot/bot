...
Deploy Bot on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/bot-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/bot` — Control UI
...
This exports your Bot state + workspace so you can migrate to another host without losing config or memory.
