...
Models are maintained in a separate repo: [vignesh07/bot-formal-models](https://github.com/vignesh07/bot-formal-models).
...
```bash
git clone https://github.com/vignesh07/bot-formal-models
cd bot-formal-models
