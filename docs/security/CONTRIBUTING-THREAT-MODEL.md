...
Spotted an attack vector or risk we haven't covered? Open an issue on [bot/trust](https://github.com/hanzoai/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.
...
- [Bot Threat Model](./THREAT-MODEL-ATLAS.md)

## Contact

- **Security vulnerabilities:** See our [Trust page](https://trust.hanzo.bot) for reporting instructions
- **Threat model questions:** Open an issue on [bot/trust](https://github.com/hanzoai/trust/issues)
