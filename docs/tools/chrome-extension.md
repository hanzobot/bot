...
- Re-run `hanzo-bot browser extension install` to refresh the installed files under your Bot state directory.
...
The CLI intentionally does **not** print a `node_modules` path. Always run `hanzo-bot browser extension install` first to copy the extension to a stable location under your Bot state directory.
