...
Install the Lobster CLI on the **same host** that runs the Bot Gateway (see the [Lobster repo](https://github.com/hanzoai/lobster)), and ensure `lobster` is on `PATH`.
