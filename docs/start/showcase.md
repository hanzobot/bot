...
<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @bot on X](https://x.com/hanzoai).
</Info>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @bot](https://x.com/hanzoai)
  </Step>
