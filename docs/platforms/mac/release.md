...
ditto -c -k --sequesterRsrc --keepParent dist/Bot.app dist/Bot-2026.2.26.zip

# Optional: also build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/Bot.app dist/Bot-2026.2.26.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/Bot.app.dSYM dist/Bot-2026.2.26.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/Bot-2026.2.26.zip https://raw.githubusercontent.com/hanzoai/bot/main/appcast.xml
```
...
- Upload `Bot-2026.2.26.zip` (and `Bot-2026.2.26.dSYM.zip`) to the GitHub release for tag `v2026.2.26`.
