...
1. Click [Deploy Hanzo Bot](https://northflank.com/stacks/deploy-bot) to open the template.
...
4. Click **Run setup**.
5. Open the Control UI at `https://<your-northflank-domain>/bot`
