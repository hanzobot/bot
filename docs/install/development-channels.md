...
When you **explicitly** switch channels with `--channel`, Hanzo Bot also aligns
the install method:
...
When you switch channels with `hanzo-bot update`, Hanzo Bot also syncs plugin sources:
