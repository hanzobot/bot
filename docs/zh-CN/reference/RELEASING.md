...
- [ ] 确认包元数据（name、description、repository、keywords、license）以及 `bin` 映射指向 [`hanzo-bot.mjs`](https://github.com/hanzoai/bot/blob/main/hanzo-bot.mjs) 作为 `bot`。
