...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/Bot-2026.1.27-beta.1.zip https://raw.githubusercontent.com/hanzoai/bot/main/appcast.xml
```
