...
- 使用现有的辅助脚本查看更丰富的输出，例如 `./scripts/botlog.sh --category WebChat --last 5m`。

## 调试后禁用

- 移除覆盖配置：`sudo rm /Library/Preferences/Logging/Subsystems/ai.hanzo.bot.plist`。
