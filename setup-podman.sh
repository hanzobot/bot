...
# Or as the hanzo-bot user: sudo -u hanzo-bot /home/hanzo-bot/run-bot-podman.sh
# If you used --quadlet, you can also: sudo systemctl --machine @hanzo/bot@ --user start bot.service
set -euo pipefail
...
if [[ "$INSTALL_QUADLET" == true && -f "$QUADLET_TEMPLATE" ]]; then
  ...
  BOT_HOME_SED="$(printf '%s' "$BOT_HOME" | sed -e 's/[\\/&|]/\\\\&/g')"
