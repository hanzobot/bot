...
Bot extension for Zalo Personal Account messaging via [zca-cli](https://zca-cli.dev).
...
```bash
hanzo-bot message send --channel zalouser --target <threadId> --message "Hello from Bot!"
```
