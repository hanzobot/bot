...
Nostr DM channel plugin for Botbot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Botbot. It enables your bot to:
...
```bash
botbot plugins install @botbot/nostr
```
...
# Configure botbot to use local relay
