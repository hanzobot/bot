...
### Changes
- Version alignment with core Botbot release numbers.
...
### Highlights
- First public release of the @botbot/voice-call plugin.
...
- CLI: `botbot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
