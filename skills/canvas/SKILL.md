...
Place files in the canvas root directory (default `~/bot/canvas/`):

```bash
cat > ~/bot/canvas/my-game.html << 'HTML'
<!DOCTYPE html>
<html>
...
Node is offline. Use `bot nodes list` to find online nodes.
...
```
http://<host>:18793/__bot__/canvas/index.html  → ~/bot/canvas/index.html
http://<host>:18793/__bot__/canvas/games/snake.html → ~/bot/canvas/games/snake.html
```
